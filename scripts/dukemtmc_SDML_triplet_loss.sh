...
jobname=CUHK03-ResNet50-SDMLTripletLoss
num_gpus=2

log_dir=/mnt/lustre/sunhongbin/person_reid/cuhk03/examples/logs/SDML-triplet-loss/dukemtmc-resnet50/tmp1101

srun -p TITANXP --job-name=$jobname --gres=gpu:$num_gpus  \
python -u examples/dukemtmc_SDML_triplet_loss.py \
    -d dukemtmc  \
    -a resnet50 \
    -b 128 \
    -j 2 \
